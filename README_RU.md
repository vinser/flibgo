...
2. Настройка
   ...
   В файле `docker-compose.yml` укажите папку, в котором будут храниться и обрабатываться файлы FB2 и zip-архивы с файлами 
   
   Папка должна иметь такую структуру:
```
books
  ├─── new - сюда помещаем новые файлы FB2 и zip-архивы с файлами
